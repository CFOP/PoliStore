...
<div class="header_top">
	...
	<div class="top_right">
		<ul>
			<li><a href="registration.html">UPSLP</a></li>|
			<li><a href="contact.html">Contacto</a></li>|
			<li class="login" >
						<div id="loginContainer"><a href="#" id="loginButton"><span>Enviar promociones</span></a>
						    <div id="loginBox">                
						        <form id="loginForm">
						                <fieldset id="body">
						                	<fieldset>
						                    ...
						                    <input type="submit" id="login" value="Enviar promociones">
